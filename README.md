...
[![Download stable](https://img.shields.io/github/release/klaoslacerda/matterbridge.svg?label=download%20stable)](https://github.com/klaoslacerda/matterbridge/releases/latest)
[![Maintainability](https://api.codeclimate.com/v1/badges/82dff70ef2ba85a6173a/maintainability)](https://codeclimate.com/github/klaoslacerda/matterbridge/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/82dff70ef2ba85a6173a/test_coverage)](https://codeclimate.com/github/klaoslacerda/matterbridge/test_coverage)<br />
...
- [Support bridging between any protocols](https://github.com/klaoslacerda/matterbridge/wiki/Features#support-bridging-between-any-protocols)
- [Support multiple gateways(bridges) for your protocols](https://github.com/klaoslacerda/matterbridge/wiki/Features#support-multiple-gatewaysbridges-for-your-protocols)
- [Message edits and deletes](https://github.com/klaoslacerda/matterbridge/wiki/Features#message-edits-and-deletes)
- Preserves threading when possible
- [Attachment / files handling](https://github.com/klaoslacerda/matterbridge/wiki/Features#attachment--files-handling)
- [Username and avatar spoofing](https://github.com/klaoslacerda/matterbridge/wiki/Features#username-and-avatar-spoofing)
- [Private groups](https://github.com/klaoslacerda/matterbridge/wiki/Features#private-groups)
- [API](https://github.com/klaoslacerda/matterbridge/wiki/Features#api)
...
More info and examples on the [wiki](https://github.com/klaoslacerda/matterbridge/wiki/Api).
...
See <https://github.com/klaoslacerda/matterbridge/wiki>

## Installing / upgrading

### Binaries

- Latest stable release [v1.26.0](https://github.com/klaoslacerda/matterbridge/releases/latest)
- Development releases (follows master) can be downloaded [here](https://github.com/klaoslacerda/matterbridge/actions) selecting the latest green build and then artifacts.

To install or upgrade just download the latest [binary](https://github.com/klaoslacerda/matterbridge/releases/latest). On \*nix platforms you may need to make the binary executable - you can do this by running `chmod a+x` on the binary (example: `chmod a+x matterbridge-1.24.1-linux-64bit`). After downloading (and making the binary executable, if necessary), follow the instructions on the [howto](https://github.com/klaoslacerda/matterbridge/wiki/How-to-create-your-config) for a step by step walkthrough for creating your configuration.

### Packages

- [Overview](https://repology.org/metapackage/matterbridge/versions)
- [snap](https://snapcraft.io/matterbridge)
- [scoop](https://github.com/klaoslacerda/scoop-bucket)

## Building

Most people just want to use binaries, you can find those [here](https://github.com/klaoslacerda/matterbridge/releases/latest)
...
Matterbridge can be build without gcc/c-compiler: If you're running on windows first run `set CGO_ENABLED=0` on other platforms you prepend `CGO_ENABLED=0` to the `go build` command. (eg `CGO_ENABLED=0 go install github.com/klaoslacerda/matterbridge`)

To install the latest stable run:

```bash
go install github.com/klaoslacerda/matterbridge
```

To install the latest dev run:

```bash
go install github.com/klaoslacerda/matterbridge@master
```

To install the latest stable run without msteams or zulip bridge:

```bash
go install -tags nomsteams,nozulip github.com/klaoslacerda/matterbridge
```
...
```bash
go install -tags whatsappmulti github.com/klaoslacerda/matterbridge@master
```

If you're low on memory and don't need msteams:

```bash
go install -tags nomsteams,whatsappmulti github.com/klaoslacerda/matterbridge@master
```
...
See [howto](https://github.com/klaoslacerda/matterbridge/wiki/How-to-create-your-config) for a step by step walkthrough for creating your configuration.

### Settings

All possible [settings](https://github.com/klaoslacerda/matterbridge/wiki/Settings) for each bridge.

### Advanced configuration

- [matterbridge.toml.sample](https://github.com/klaoslacerda/matterbridge/blob/master/matterbridge.toml.sample) for documentation and an example.
...
Please take a look at the [Docker Wiki page](https://github.com/klaoslacerda/matterbridge/wiki/Deploy:-Docker) for more information.

### Systemd

Please take a look at the [Service Files page](https://github.com/klaoslacerda/matterbridge/wiki/Service-files) for more information.

## Changelog

See [changelog.md](https://github.com/klaoslacerda/matterbridge/blob/master/changelog.md)

## FAQ

See [FAQ](https://github.com/klaoslacerda/matterbridge/wiki/FAQ)
...
[mb-gitter]: https://gitter.im/klaoslacerda/matterbridge
