...
func (b *Bsteam) handleChatMsg(e *steam.ChatMsgEvent) {
	...
	if e.ChatRoomId == 0 {
		...
		// TODO
		// https://github.com/klaoslacerda/matterbridge/pull/630#discussion_r238102751
...
func (b *Bsteam) handleLogOnFailed(e *steam.LogOnFailedEvent, myLoginInfo *steam.LogOnDetails) error {
	...
	case steamlang.EResult_AccountLoginDeniedNeedTwoFactor:
		...
		var code string
		fmt.Scanf("%s", &code)
		// TODO https://github.com/klaoslacerda/matterbridge/pull/630#discussion_r238103978
